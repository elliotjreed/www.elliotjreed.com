  ...
  <section className="divide-y divide-gray-200 dark:divide-gray-700">
    ...
    <div className="prose max-w-none dark:prose-dark">
      <section>
        ...
        <p>
          This information is collected to ensure the security and proper functioning of the website. It is stored for a
          limited period and is not used for tracking or marketing purposes.
        </p>

        <h4>Cookies</h4>
        <p>
          This website does not use any tracking or analytics cookies. The only cookies that may be used are those
          essential for the website's functionality (such as those required by Cloudflare for security purposes). These
          cookies do not track you across different websites and do not store personal information beyond what is
      ...
      <section>
        <h2>Data Security</h2>
        <p>
          I take reasonable measures to protect your information from unauthorised access, use, or disclosure. However,
      ...
      <section>
        ...
        <p>
          To exercise any of these rights, please contact me at <a href={`mailto:${emailAddress}`}>{emailAddress}</a>.
        </p>
      </section>
      ...
      <section>
        <h2>Complaints</h2>
        <p>
          If you have concerns about how I handle your personal data, please contact me at{" "}
          <a href={`mailto:${emailAddress}`}>{emailAddress}</a> first so I can address your concerns. If you are not
          satisfied with my response, you have the right to complain to the Information Commissioner's Office (ICO), the
