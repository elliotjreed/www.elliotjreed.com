              ...
              <div className="card">
                <div className="columns is-vcentered has-text-centered">
                  ...
                  <section className="column is-8 has-text-dark">
                    ...
                    <p>
                      This website is built with React JS on the frontend, and Python on the backend using the asynchronous Sanic webserver. The code is available on <a href="https://github.com/elliotjreed">GitHub</a>.
                    </p>
                  </section>
