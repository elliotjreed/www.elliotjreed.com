    ...
    <section className="divide-y divide-gray-200 dark:divide-gray-700">
      <div className="space-y-2 pt-6 pb-8 md:space-y-5">
        ...
        <p className="text-lg leading-7 text-gray-500 dark:text-gray-400">
          ...
          <Link to="ai-prompt-engineering-guide">AI Prompt Engineering Guide</Link>.
        </p>
      </div>
        ...
        <section id="example_prompts">
          ...
          <section>
            ...
            <p className="italic">
              ...
              <br />
              <strong>Format:</strong> Provide a visual layout description with seasonal planting recommendations.
              Include a short shopping list of essential plants and materials, and a monthly maintenance calendar.
              <br />
              <strong>Examples:</strong> My neighbour created a successful small garden using raised beds to overcome
              poor drainage, and my sister incorporated vertical growing spaces with trellises to maximise her limited
              garden footprint.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="italic">
              ...
              was born around 1885 in Glasgow and worked as a shipbuilder, but I've found conflicting information about
          ...
          <section>
            ...
            <p className="italic">
              ...
              actions children can take. Include suggestions for simple demonstrations or activities that require
              minimal materials.
              <br />
              Previous successful presentations to this age group have used the "greenhouse as a blanket" analogy and
              incorporated sorting activities where children categorised everyday actions as "helps the planet" or
              "harms the planet."
            </p>
          </section>
        </section>
