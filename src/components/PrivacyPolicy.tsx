  ...
  return (
    <animated.section className="divide-y divide-gray-200 dark:divide-gray-700" style={springProps}>
      ...
      <div className="prose max-w-none dark:prose-dark">
        ...
        <p>
          I monitor visitors to my websites by using cookies and may process data about your use using an analytics
          platform (such as{" "}
          <a href="https://policies.google.com/privacy?hl=en-GB" rel="noreferrer noopener">
            Google Analytics
          </a>
          ). Your web browser should provide you with the controls to manage and delete cookies from your device; please
