                  ...
                  <section className="summary">
                    ...
                    <div className="wrapper">
                      ...
                      <p>
                        ...
                        multi-channel ecommerce industry primarily using object-oriented PHP, MySQL, Javascript, HTML,
                        and CSS, with various APIs and frameworks on Linux using Docker, Ansible, and Apache and NginX.
                        Worked using Agile / Scrum methodologies with test-driven development to SOLID design
                        principles.
                      </p>
                    </div>
                  </section>
                    ...
                    <section>
                      ...
                      <div className="content">
                        <div className="columns is-desktop">
                          <ul className="column">
                            <li>
                              Trained junior developers in <abbr title="Test-Driven Development">TDD</abbr>, SOLID
                              design principles, and Clean Code;
                            </li>
                            <li>Refactored legacy codebases;</li>
                            <li>
                              Introduced and implemented an Elastic Stack for more advanced logging and analytics;
                            </li>
