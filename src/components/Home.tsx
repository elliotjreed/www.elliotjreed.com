              ...
              <div className="card">
                <div className="columns is-vcentered has-text-centered">
                  ...
                  <section className="column is-8 has-text-dark">
                    ...
                    <p>
                      Hi! I’m Elliot, a software developer based in Nottingham. My interests are generally in E-Commerce, PHP, Javascript, Docker, and general
                      DevOps.
                    </p>
                    <p>
                      This website contains little mini-guides and snippets which may prove helpful, and if you’re stuck on anything you think I may be able to
                      help with give me a shout on <a href="https://twitter.com/elliotjreed">Twitter</a>.
                    </p>
                    <p>
                      This website is built with React JS on the frontend, and Python on the backend using the asynchronous Sanic webserver. The code is
